...
public class ReportesEmitidosDuplicarComplLeyendasFiscalesTest2 extends base{
	...
	@Test 
	public void duplicadoLeyendasFiscalesNotificado() throws IOException, InterruptedException {
		 
		       LandingPageBuson ld = new LandingPageBuson(driver);
		
		//DUPLICADO DE FACTURA COMPLEMENTOS LEYENDAS FISCALES
		...
		//Thread.sleep(2000);
		try {
			boolean displayedPending = driver.findElement(By.xpath("//span[contains(text(),'Pendiente de aprobación')]")).isEnabled();
			boolean displayedSent = driver.findElement(By.xpath("//span[contains(text(),'Entregado SAT')]")).isEnabled();
			boolean displayedCanceled = driver.findElement(By.xpath("//span[contains(text(),'Cancelado')]")).isEnabled();
		...
		Thread.sleep(1000);
		ld.DuplicarLeyendasFiscales().click();
		Thread.sleep(2000);
