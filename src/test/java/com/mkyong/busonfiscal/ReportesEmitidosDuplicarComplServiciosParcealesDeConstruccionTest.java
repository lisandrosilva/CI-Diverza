...
public class ReportesEmitidosDuplicarComplServiciosParcealesDeConstruccionTest extends base{
	...
	@Test 
	public void duplicadserviosParcealesDeConstrucion() throws IOException, InterruptedException {
		 
		       LandingPageBuson ld = new LandingPageBuson(driver);
		
		//DUPLICADO DE FACTURA SERVICIOS PARCEALES DE CONSTRUCCION
		...
		Thread.sleep(1000);
		ld.DuplicarServiciosParcelConst().click();
		Thread.sleep(2000);
