...
public class BusquedaReportesTest16 extends base{
	...
	@Test 
	public void busquedaDeReportes16() throws IOException, InterruptedException {
		...
		Thread.sleep(2000);
		ld.StatusPendientesDeApr().click();
		Thread.sleep(2000);
