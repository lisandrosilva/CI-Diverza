...
public class ImpuestosLocalesDetailTest extends base{
	...
	@Test 
	public void facturaImpuestosLocalesDetail1() throws IOException, InterruptedException {
		...
		l.TasaF().click();
		l.CuotaOtasaLocal().sendKeys("1.60000");
