...
public class FacturaPagoDetailTest extends base{
	...
	@Test 
	public void facturaPagoDetail() throws IOException, InterruptedException {
...
//		WebElement ComplementoRelPago = driver.findElement(By.id("show-related_cfdi_complement-form']"));
//	    JavascriptExecutor js = (JavascriptExecutor)driver;
//	    js.executeScript("arguments[0].click();",ComplementoRelPago);
//	    s.ComplementoRelacionadoPago().sendKeys("1f63b023-8faf-4c02-aaed-e71e991d4760");
//	    s.FolioPago().sendKeys("676");
//	    s.MethodDePagoComprobantes().click();
//	    List<WebElement> list = driver.findElements(By.xpath("//ul[contains(@class,'list')]//li"));
//	    for(int i=0; i<list.size(); i++) {
//	    	System.out.println(list.size());
//	    	if(list.get(i).getText().contains("PPD - Pago en parcialidades o diferido")) {
//	    		list.get(i).click();
//	    		break;
//	    	}
//	    }
//	    Thread.sleep(3000);
	    ...
	    j.executeScript("arguments[0].click();",ComprobanteRelacionado);
