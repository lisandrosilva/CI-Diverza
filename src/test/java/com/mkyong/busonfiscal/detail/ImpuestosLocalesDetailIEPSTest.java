...
public class ImpuestosLocalesDetailIEPSTest extends base{
	...
	@Test 
	public void facturaImpuestosLocalesII() throws IOException, InterruptedException {
        ...
        ps.ClaveDelProducto().sendKeys("10121800");
        ps.CantidadConsept().sendKeys("20");
        ps.ClaveDeUnidad().sendKeys("KGM");
        ps.DescripticionConsept().sendKeys("Alimentos Para Perros y Gatos");
        ps.ValorUnitarioConsept().sendKeys("50.00");
        //Thread.sleep(2000);
		...
		l.DescriptOtroIdioma().sendKeys("English");
