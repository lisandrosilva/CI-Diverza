...
public class VehiculosUsadosDetailTest2 extends base{
	...
	@Test 
	public void vehiculosUsadosDetail2() throws IOException, InterruptedException {
        ...
        ps.ClaveDelProducto().sendKeys("10101505");
        ps.CantidadConsept().sendKeys("1");
        ps.ClaveDeUnidad().sendKeys("58");
        ps.DescripticionConsept().sendKeys("Test");
        ps.ValorUnitarioConsept().sendKeys("1000");
       ...
       //Thread.sleep(1000);
        ...
        ps.ValorVehicUsado().sendKeys("1.5");
        //Thread.sleep(1000);
