...
public class ServiciosParcealesDeContrucciondDetailTest2 extends base{
	...
	@Test 
	public void serviciosParcealesDeconstruccionDetail2() throws IOException, InterruptedException {
		...
		//Thread.sleep(1000);
		n.ButtonDatosPrtsOComprConstr().click();
        ...
        //n.ButtonInfoAdendaConstru().click();
		...
		//n.ButtonComprRelaConstruc().click();
