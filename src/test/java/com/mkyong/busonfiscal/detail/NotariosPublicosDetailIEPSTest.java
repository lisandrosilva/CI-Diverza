...
public class NotariosPublicosDetailIEPSTest extends base{
	...
	@Test 
	public void notaDeCreditoDetailII() throws IOException, InterruptedException {
        ...
        ps.ClaveDelProducto().sendKeys("95122306");
