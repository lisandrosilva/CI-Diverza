...
public class BusquedaReportesTest7 extends base{
	...
	@Test 
	public void busquedaDeReportes7() throws IOException, InterruptedException {
		...
		Thread.sleep(2000);
		ld.TransferenciaElectronica().click();
		Thread.sleep(2000);
