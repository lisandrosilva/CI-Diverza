...
public class ReportesEmitidosDuplicarComprobanteNotaDeCreditoTest extends base{
	...
	@Test 
	public void duplicadoComprNotaDeCredito() throws IOException, InterruptedException {
		...
		Thread.sleep(1000);
		ld.DuplicarNotaDeCredito().click();
		Thread.sleep(2000);
