...
public class TestReportesEmitidosDuplicarComplComercioExterior extends base{
	 @BeforeTest
	...
	public void basePageNavigation() throws IOException, InterruptedException {
		...
		//DUPLICADO DE FACTURA COMERCIO EXTERIOR INGRESO
		...
		Thread.sleep(2000);
		ld.DuplicadoComercioIngreso().click();
