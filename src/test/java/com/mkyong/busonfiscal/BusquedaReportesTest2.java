...
public class BusquedaReportesTest2 extends base{
	...
	@Test 
	public void buquedaDeReportes2() throws IOException, InterruptedException {
		...
		Thread.sleep(2000);
		ld.ExportarCFDI().click();
		
		ld.ExportarEmitido().click();
