...
public class ImpresionIETFiscalTest9 extends base{
	...
	@Test 
	public void impressionFiscal9() throws IOException, InterruptedException, AWTException {
		...
		Thread.sleep(2000);
		ld.TemplateName().sendKeys("Lisandro2");
		Thread.sleep(3000);
