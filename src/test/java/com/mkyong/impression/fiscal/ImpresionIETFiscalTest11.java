...
public class ImpresionIETFiscalTest11 extends base{
	...
	@Test 
	public void impressionFiscal11() throws IOException, InterruptedException, AWTException {
		...
		Thread.sleep(2000);
		ld.TemplateName().sendKeys("Lisandro5");
		Thread.sleep(3000);
