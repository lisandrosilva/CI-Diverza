...
public class ImpresionIETFiscalTest12 extends base{
	...
	@Test 
	public void impressionFiscal12() throws IOException, InterruptedException, AWTException {
		...
		Thread.sleep(2000);
		ld.TemplateName().sendKeys("Lisandro6");
		Thread.sleep(3000);
		...
		for (int i=0; i<list.size();i++) {
			...
			if(list.get(i).getText().contains("Inferior Centro")) {
				list.get(i).click();
				break;
			}
