...
public class ImpresionNominaFiscalTest extends base{
	...
	@Test 
	public void impressionNomina() throws IOException, InterruptedException, AWTException {
		...
		ld.Plantillas().click();
		Thread.sleep(2000);
		ld.NominaImpresionFiscal().click();
		Thread.sleep(2000);
		ld.TemplateNominaImpr().click();
		Thread.sleep(2000);
