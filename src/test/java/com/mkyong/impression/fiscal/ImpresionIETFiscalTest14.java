...
public class ImpresionIETFiscalTest14 extends base{
	...
	@Test 
	public void impressionFiscal14() throws IOException, InterruptedException, AWTException {
		...
		Thread.sleep(2000);
		ld.TemplateName().sendKeys("Lisandro8");
		Thread.sleep(3000);
