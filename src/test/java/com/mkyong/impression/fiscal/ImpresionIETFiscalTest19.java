...
public class ImpresionIETFiscalTest19 extends base{
	...
	@Test 
	public void impressionFiscal19() throws IOException, InterruptedException, AWTException {
		...
		Thread.sleep(2000);
		ld.TemplateName().sendKeys("Marilyn");
		Thread.sleep(3000);
		...
		for (int i=0; i<list.size();i++) {
			...
			if(list.get(i).getText().contains("Superior Centro")) {
				list.get(i).click();
				break;
			}
