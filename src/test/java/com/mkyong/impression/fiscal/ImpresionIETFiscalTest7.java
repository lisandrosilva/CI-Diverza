...
public class ImpresionIETFiscalTest7 extends base{
	...
	@Test 
	public void impressionFiscal7() throws IOException, InterruptedException, AWTException {
		...
		Thread.sleep(2000);
		ld.TemplateName().sendKeys("Lisandro");
		Thread.sleep(3000);
		...
		for (int i=0; i<list.size();i++) {
			...
			if(list.get(i).getText().contains("Superior Derecha")) {
				list.get(i).click();
				break;
			}
