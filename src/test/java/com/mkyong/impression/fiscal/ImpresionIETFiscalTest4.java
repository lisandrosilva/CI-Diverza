...
public class ImpresionIETFiscalTest4 extends base{
	...
	@Test 
	public void impressionFiscal4() throws IOException, InterruptedException, AWTException {
		...
		Thread.sleep(2000);
		ld.TemplateName().sendKeys("Marce");
		Thread.sleep(3000);
		...
		for (int i=0; i<list.size();i++) {
			...
			if(list.get(i).getText().contains("Superior Izquierdo")) {
				list.get(i).click();
				break;
			}
