...
public class ConciliacionTest2 extends base{
	...
	@Test 
	public void conciliacionFiscal2() throws IOException, InterruptedException, AWTException {
	    ...
	    System.out.println(list.size());
	    // Por Estatus
	    driver.findElement(By.xpath("//span[contains(text(),'Estatus (Ingreso)')]")).click();
	    List<WebElement> li = driver.findElements(By.xpath("//ul[contains(@class,'dropdown-menu inner')]//li//a//span"));
	    for(int i=0; i<li.size(); i++) {
	    	System.out.println(li.size());
	    	if(li.get(i).getText().contains("En Proceso")) {
	    		li.get(i).click();
	    		break;
	    	}
	    }
