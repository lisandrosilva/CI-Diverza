...
public class ConciliacionTest95 extends base{
	...
	public void conciliacionFiscal1() throws IOException, InterruptedException, AWTException {
	    ...
	    for(int i=0; i<li.size(); i++) {
	    	...
	    	if(li.get(i).getText().contains("Con CFDI")) {
	    		li.get(i).click();
	    		break;
	    	}
	    }
	    ...
	    ld.CuentaBancaria().sendKeys("123458old");
	    ld.DataFinalIngresConc().sendKeys("14-2-2020");
	    ld.DataFinalIngresConc().sendKeys("5-3-2020");
