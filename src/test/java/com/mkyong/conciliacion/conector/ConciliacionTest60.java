...
public class ConciliacionTest60 extends base{
	...
	public void conciliacionFiscal1() throws IOException, InterruptedException, AWTException {
	    ...
	    for(int i=0; i<list.size(); i++) {
	    	...
	    	if(list.get(i).getText().contains("Comprobantes de Pago")) {
	    		list.get(i).click();
	    		break;
	    	}
	    }
	    ...
	    System.out.println(list.size());
	    // Por Estatus
	    driver.findElement(By.xpath("//button[@data-id='document_received_payment_payment_way_id']")).click();
	    List<WebElement> li = driver.findElements(By.xpath("//ul[contains(@class,'dropdown-menu inner')]//li//a//span"));
	    for(int i=0; i<li.size(); i++) {
	    	System.out.println(li.size());
	    	if(li.get(i).getText().contains("PPD - Pago en parcialidades o diferido")) {
	    		li.get(i).click();
	    		break;
	    	}
	    }
