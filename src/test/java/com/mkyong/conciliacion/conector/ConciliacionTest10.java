...
public class ConciliacionTest10 extends base{
	...
	public void conciliacionFiscal1() throws IOException, InterruptedException, AWTException {
	    ...
	    for(int i=0; i<li.size(); i++) {
	    	...
	    	if(li.get(i).getText().contains("Parcialmente Pagado")) {
	    		li.get(i).click();
	    		break;
	    	}
	    }
	    ...
	    Thread.sleep(2000);
	    ld.Ver().click();
	    Assert.assertEquals("Detalle del comprobante   ", "Detalle del comprobante   ");
		ld.SignOut().click();
		Thread.sleep(2000);
