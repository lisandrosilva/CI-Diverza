...
public class LeyendasFiscalesJesDetailTest extends base{
	...
	@Test 
	public void leyendasFiscalesDetailJes() throws IOException, InterruptedException {
		...
		fact.FacturaLeyendasFiscales().click();
		//Thread.sleep(1000);
